...
const styles = {
  page: {
    minHeight: '100vh',
    padding: '24px',
    background: 'linear-gradient(135deg, #10151d 0%, #070a0f 100%)',
    color: '#f8fafc',
  },
  shell: {
    maxWidth: '1200px',
  ...
  title: {
    ...
    fontWeight: 850,
    letterSpacing: 0,
    background: 'linear-gradient(90deg, #6af0a7 0%, #ffd166 100%)',
  ...
  card: {
    ...
    borderRadius: 8,
    border: '1px solid rgba(148, 163, 184, 0.16)',
    background: 'linear-gradient(180deg, rgba(22, 27, 36, 0.94) 0%, rgba(9, 12, 18, 0.98) 100%)',
  ...
  accent: {
    ...
    width: '100%',
    height: '4px',
    background: 'linear-gradient(90deg, #6af0a7, #ffd166)',
    opacity: 0.8,
  },
  topRow: {
    display: 'flex',
            ...
            {printers.map((printer) => {
              ...
              return (
                <section key={printer.dev_id} style={styles.card}>
                  {printer.status === 'printing' ? <div style={styles.accent} /> : null}
                    ...
                    <div style={styles.progressTrack}>
                      <div
                        style={{
                          ...
                          height: '100%',
                          borderRadius: '999px',
                          background: `linear-gradient(90deg, ${statusMeta.color}, #ffd166)`,
